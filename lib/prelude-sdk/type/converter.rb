    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in PreludeSDK::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [PreludeSDK::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(PreludeSDK::Type::Converter) ? target.dump(value) : PreludeSDK::Unknown.dump(value)
        end
      end
    end
