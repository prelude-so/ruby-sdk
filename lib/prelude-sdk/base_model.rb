...
module PreludeSDK
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in PreludeSDK::Converter | Module | Symbol
          -> { spec }
        in true | false
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(PreludeSDK::Enum) && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    private def variant(key, spec = nil)
      variant_info =
        ...
        in Proc | PreludeSDK::Converter | Module | Hash
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(PreludeSDK::Union) && other.derefed_variants == derefed_variants
    end
    ...
    def coerce(value)
      if (variant = resolve_variant(value))
        return PreludeSDK::Converter.coerce(variant, value)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        case PreludeSDK::Converter.try_strict_coerce(variant, value)
        in [true, coerced, _]
          return coerced
        in [false, true, score]
      ...
      variant.nil? ? value : PreludeSDK::Converter.coerce(variant, value)
    end
    ...
    def dump(value)
      if (variant = resolve_variant(value))
        return PreludeSDK::Converter.dump(variant, value)
      end
  ...
  class ArrayOf
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(PreludeSDK::ArrayOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { PreludeSDK::Converter.coerce(type, _1) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { PreludeSDK::Converter.dump(type, _1) }.to_a
      else
        value
      end
    end
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case PreludeSDK::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class HashOf
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(PreludeSDK::HashOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = PreludeSDK::Converter.coerce(type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          PreludeSDK::Converter.dump(type, val)
        end
      else
        value
      end
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case PreludeSDK::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class BaseModel
    ...
    class << self
      ...
      def reverse_map
        @reverse_map ||= (self < PreludeSDK::BaseModel ? superclass.reverse_map.dup : {})
      end
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Module | PreludeSDK::Converter
        ...
        define_method(name_sym) do
          ...
          PreludeSDK::Converter.coerce(field_type, value)
    ...
    class << self
      ...
      def coerce(value)
        case PreludeSDK::Util.coerce_hash(value)
        in Hash => coerced
          new(coerced)
        else
          value
      ...
      def try_strict_coerce(value)
        ...
        known_fields.each_value do |field|
          ...
          in [_, true]
            ...
            case PreludeSDK::Converter.try_strict_coerce(target, item)
            in [true, coerced, score]
              tally += score
    ...
    def initialize(data = {})
      ...
      in Hash => coerced
        @data = coerced.to_h do |key, value|
          ...
          stored =
            case [type, value]
            in [Module, Hash] if type <= PreludeSDK::BaseModel
              type.new(value)
            in [PreludeSDK::ArrayOf, Array] | [PreludeSDK::HashOf, Hash]
              type.coerce(value)
            else
              value
            end
