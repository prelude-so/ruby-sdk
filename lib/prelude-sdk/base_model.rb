...
module PreludeSDK
  ...
  module Converter
    ...
    #
    #   @option spec [Proc, PreludeSDK::Converter, Class] :enum
    #
    #   @option spec [Proc, PreludeSDK::Converter, Class] :union
    #
  ...
  class ArrayOf
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { |item| PreludeSDK::Converter.coerce(type, item) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { |item| PreludeSDK::Converter.dump(type, item) }.to_a
      else
        value
      end
    end
  ...
  class BaseModel
    ...
    #
    # @param type_info [Proc, PreludeSDK::Converter, Class, Hash{Symbol=>Object}, nil]
    #
    # @param spec [Hash{Symbol=>Object}, Proc, PreludeSDK::Converter, Class] .
    #
    #   @option spec [NilClass, TrueClass, FalseClass, Integer, Float, Symbol] :const
