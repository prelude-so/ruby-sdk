...
module PreludeSDK
  ...
  module Converter
    # @private
    # @param spec [Proc, Class, PreludeSDK::Converter, Hash]
    #
    # @return [Proc]
    #
  ...
  class Union
    ...
    private_class_method def self.variant(key, spec = {})
      variant_info =
        ...
        in Proc | Class | PreludeSDK::Converter | Hash
  ...
  class ArrayOf
    ...
    def initialize(type_info, spec = {})
      @items_type_fn = PreludeSDK::Converter.type_info(type_info || spec)
    end
  end
