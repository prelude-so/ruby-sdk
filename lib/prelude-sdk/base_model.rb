...
module PreludeSDK
  ...
  class ArrayOf
    ...
    def initialize(spec = {})
      @items_type_fn = PreludeSDK::Converter.type_info(spec)
    end
  end
    ...
    private_class_method def self.add_field(name_sym, required:, type_info:, spec:)
      type_fn, api_name =
        ...
        in Proc | Class | PreludeSDK::Converter
          [PreludeSDK::Converter.type_info({**spec, union: type_info}), spec[:api_name]]
        in Hash
          [PreludeSDK::Converter.type_info(type_info), type_info[:api_name]]
        end
