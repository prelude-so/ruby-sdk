...
module PreludeSDK
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in PreludeSDK::Converter | Class | Symbol
          -> { spec }
      ...
      def dump(target, value)
        target.is_a?(PreludeSDK::Converter) ? target.dump(value) : PreludeSDK::Unknown.dump(value)
      end
    end
  end
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class <= PreludeSDK::Enum && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    # @api private
    #
    # @param key [Symbol, Hash{Symbol=>Object}, Proc, PreludeSDK::Converter, Class]
    #
    # @param spec [Hash{Symbol=>Object}, Proc, PreludeSDK::Converter, Class] .
    #
    #   @option spec [NilClass, TrueClass, FalseClass, Integer, Float, Symbol] :const
    ...
    private def variant(key, spec = nil)
      variant_info =
        case key
        in Symbol
          [key, PreludeSDK::Converter.type_info(spec)]
        in Proc | PreludeSDK::Converter | Class | Hash
          [nil, PreludeSDK::Converter.type_info(key)]
        end
    ...
    # @param value [Object]
    #
    # @return [PreludeSDK::Converter, Class, nil]
    private def resolve_variant(value)
      ...
      in [Symbol, Hash]
        key = value.fetch(@discriminator) do
          value.fetch(@discriminator.to_s, PreludeSDK::Util::OMIT)
        end

        return nil if key == PreludeSDK::Util::OMIT
    ...
    def coerce(value, state:)
      if (target = resolve_variant(value))
        return PreludeSDK::Converter.coerce(target, value, state: state)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        coerced = PreludeSDK::Converter.coerce(target, value, state: state)
    ...
    def dump(value)
      if (target = resolve_variant(value))
        return PreludeSDK::Converter.dump(target, value)
      end

      known_variants.each do
        target = _2.call
        return PreludeSDK::Converter.dump(target, value) if target === value
      end
  ...
  class ArrayOf
    ...
    # @param type_info [Hash{Symbol=>Object}, Proc, PreludeSDK::Converter, Class]
    #
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(PreludeSDK::ArrayOf) && other.nilable? == nilable? && other.item_type == item_type
      ...
      value
        .map do |item|
          ...
          in [true, nil]
            ...
            PreludeSDK::Converter.coerce(target, item, state: state)
          end
        end
    end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Array) ? value.map { PreludeSDK::Converter.dump(target, _1) } : super
    end

    # @api private
    #
    # @return [PreludeSDK::Converter, Class]
    ...
    def initialize(type_info, spec = {})
      @item_type_fn = PreludeSDK::Converter.type_info(type_info || spec)
      @nilable = spec[:nil?]
    end
  end
  ...
  class HashOf
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(PreludeSDK::HashOf) && other.nilable? == nilable? && other.item_type == item_type
        ...
        .to_h do |key, val|
          ...
          v =
            ...
            in [true, nil]
              ...
              PreludeSDK::Converter.coerce(target, val, state: state)
            end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Hash) ? value.transform_values { PreludeSDK::Converter.dump(target, _1) } : super
    end
  ...
  class BaseModel
    ...
    class << self
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | PreludeSDK::Converter | Class
            [PreludeSDK::Converter.type_info({**spec, union: type_info}), spec]
          in Hash
            [PreludeSDK::Converter.type_info(type_info), type_info]
          end

        setter = "#{name_sym}="
        api_name = info.fetch(:api_name, name_sym)
        nilable = info[:nil?]
        const = required && !nilable ? info.fetch(:const, PreludeSDK::Util::OMIT) : PreludeSDK::Util::OMIT
        ...
        define_method(name_sym) do
          target = type_fn.call
          value = @data.fetch(name_sym) { const == PreludeSDK::Util::OMIT ? nil : const }
          state = {strictness: :strong, exactness: {yes: 0, no: 0, maybe: 0}, branched: 0}
          if (nilable || !required) && value.nil?
            nil
          else
            PreludeSDK::Converter.coerce(
              target,
              value,
              state: state
            )
    ...
    class << self
      ...
      def coerce(value, state:)
        ...
        unless (val = PreludeSDK::Util.coerce_hash(value)).is_a?(Hash)
          exactness[:no] += 1
          return value
        end
        exactness[:yes] += 1
        ...
        fields.each do |name, field|
          ...
          converted =
            if item.nil? && (nilable || !required)
              ...
              coerced = PreludeSDK::Converter.coerce(target, item, state: state)
              case target
              in PreludeSDK::Converter | Symbol
                coerced
              else
                item
              end
      ...
      def dump(value)
        ...
        coerced.each do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              acc.store(api_name, PreludeSDK::Converter.dump(target, val))
            end
          end
        end
        ...
        known_fields.each_value do |field|
          ...
          next if mode == :coerce || acc.key?(api_name) || const == PreludeSDK::Util::OMIT
    ...
    def initialize(data = {})
      case PreludeSDK::Util.coerce_hash(data)
      in Hash => coerced
        @data = coerced
      else
