...
module PreludeSDK
  module Transport
    ...
    class BaseClient
      ...
      PLATFORM_HEADERS =
        {
          "x-stainless-arch" => PreludeSDK::Util.arch,
          "x-stainless-lang" => "ruby",
          "x-stainless-os" => PreludeSDK::Util.os,
      ...
      # @api private
      # @return [PreludeSDK::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = PreludeSDK::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [PreludeSDK::Type::Converter, Class, nil] :model
      #
      ...
      private def build_request(req, opts)
        ...
        query = PreludeSDK::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
        ...
        body =
          ...
          in :get | :head | :options | :trace
            ...
            PreludeSDK::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
          end

        headers, encoded = PreludeSDK::Util.encode_content(headers, body)
        {
          method: method,
          url: PreludeSDK::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
          headers: headers,
          body: encoded,
      ...
      private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
        ...
        input = {**request.except(:timeout), deadline: PreludeSDK::Util.monotonic_secs + timeout}
        ...
        in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
          decoded = Kernel.then do
            PreludeSDK::Util.decode_content(response, stream: stream, suppress_error: true)
          ensure
            self.class.reap_connection!(status, stream: stream)
          end
      ...
      def request(req)
        ...
        model = req.fetch(:model) { PreludeSDK::Unknown }
        ...
        decoded = PreludeSDK::Util.decode_content(response, stream: stream)
        case req
        in { stream: Class => st }
        ...
        in { page: Class => page }
          ...
          PreludeSDK::Type::Converter.coerce(model, unwrapped)
        end
      end
