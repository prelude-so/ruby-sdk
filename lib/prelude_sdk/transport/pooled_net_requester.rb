    ...
    class PooledNetRequester
      ...
      class << self
        ...
        def calibrate_socket_timeout(conn, deadline)
          timeout = deadline - PreludeSDK::Util.monotonic_secs
        ...
        def build_request(request, &blk)
          ...
          in String
            ...
            req.body_stream = PreludeSDK::Util::ReadIOAdapter.new(body, &blk)
          in StringIO
      ...
      def execute(request)
        ...
        body = PreludeSDK::Util.fused_enum(enum, external: true) do
          finished = true
          tap do
            enum.next
