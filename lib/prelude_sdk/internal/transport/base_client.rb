  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => PreludeSDK::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => PreludeSDK::Internal::Util.os,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = PreludeSDK::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise PreludeSDK::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if PreludeSDK::Internal::Util.uri_origin(url) != PreludeSDK::Internal::Util.uri_origin(location)
          ...
          def reap_connection!(status, stream:)
            ...
            in PreludeSDK::Errors::APIConnectionError | (500..)
              PreludeSDK::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        def initialize(
          ...
          @requester = PreludeSDK::Internal::Transport::PooledNetRequester.new
          @headers = PreludeSDK::Internal::Util.normalized_headers(
        ...
        private def build_request(req, opts)
          ...
          path = PreludeSDK::Internal::Util.interpolate_path(uninterpolated_path)

          query = PreludeSDK::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
        ...
        private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise PreludeSDK::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
        ...
        #
        # @param options [PreludeSDK::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
