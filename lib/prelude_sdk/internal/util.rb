    ...
    module Util
      ...
      class << self
        ...
        def encode_content(headers, body)
          ...
          in [PreludeSDK::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [PreludeSDK::Internal::Util::JSONL_CONTENT, Enumerable] unless body.is_a?(PreludeSDK::Internal::Type::FileInput)
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | PreludeSDK::Internal::Type::FileInput]
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [PreludeSDK::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in PreludeSDK::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            else
              type
            end
