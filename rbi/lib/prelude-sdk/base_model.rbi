...
module PreludeSDK
          ...
          spec: T.any(
            {
              ...
              enum: T.nilable(T.proc.returns(PreludeSDK::Converter::Input)),
              union: T.nilable(T.proc.returns(PreludeSDK::Converter::Input))
            },
  ...
  module Union
    ...
    sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(PreludeSDK::Converter::Input)]]) }
    ...
    sig do
      params(
        key: T.any(Symbol, PreludeSDK::Util::AnyHash, T.proc.returns(T.anything), T.anything),
        spec: T.any(PreludeSDK::Util::AnyHash, T.proc.returns(T.anything), T.anything)
      )
        .void
    end
  ...
  class ArrayOf
    ...
    sig(:final) do
      params(
        type_info: T.any(
          PreludeSDK::Util::AnyHash,
          T.proc.returns(PreludeSDK::Converter::Input),
          PreludeSDK::Converter::Input
        ),
        spec: PreludeSDK::Util::AnyHash
      )
  ...
  class BaseModel
    ...
    class << self
      ...
      sig do
        returns(
          ...
          Symbol,
          T.all(
            PreludeSDK::BaseModel::KnownFieldShape,
            {type_fn: T.proc.returns(PreludeSDK::Converter::Input)}
          )
          ]
        )
      end
    ...
    sig { overridable.returns(PreludeSDK::Util::AnyHash) }
    def to_h
    end
    ...
    sig { params(keys: T.nilable(T::Array[Symbol])).returns(PreludeSDK::Util::AnyHash) }
