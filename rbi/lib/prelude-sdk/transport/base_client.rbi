...
module PreludeSDK
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[PreludeSDK::Type::BasePage[PreludeSDK::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(PreludeSDK::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: PreludeSDK::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: PreludeSDK::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(PreludeSDK::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(PreludeSDK::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(req: PreludeSDK::Transport::BaseClient::RequestComponentsShape, opts: PreludeSDK::Util::AnyHash)
          .returns(PreludeSDK::Transport::BaseClient::RequestInputShape)
      end
