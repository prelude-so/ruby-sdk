  ...
  module Internal
    module Type
      ...
      module Union
        ...
        sig do
          params(
            key: T.any(Symbol, PreludeSDK::Internal::Util::AnyHash, T.proc.returns(T.anything), T.anything),
            spec: T.any(PreludeSDK::Internal::Util::AnyHash, T.proc.returns(T.anything), T.anything)
          )
            .void
        end
