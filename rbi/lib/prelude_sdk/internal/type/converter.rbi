...
module PreludeSDK
  module Internal
    module Type
      # @api private
      module Converter
        Input = T.type_alias { T.any(PreludeSDK::Internal::Type::Converter, T::Class[T.anything]) }
        ...
        sig do
          overridable
            .params(value: T.anything, state: PreludeSDK::Internal::Type::Converter::State)
            .returns(T.anything)
        end
        ...
        class << self
          ...
          sig do
            params(
              target: PreludeSDK::Internal::Type::Converter::Input,
              value: T.anything,
