...
module PreludeSDK
  module Internal
    ...
    module Util
      ...
      #   structure when using `PreludeSDK::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(PreludeSDK::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        # @api private
        sig { params(url: T.any(URI::Generic, String)).returns(PreludeSDK::Internal::Util::ParsedUriShape) }
        def parse_uri(url)
        end

        # @api private
        sig { params(parsed: PreludeSDK::Internal::Util::ParsedUriShape).returns(URI::Generic) }
        ...
        sig do
          params(
            lhs: PreludeSDK::Internal::Util::ParsedUriShape,
            rhs: PreludeSDK::Internal::Util::ParsedUriShape
          )
            .returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(PreludeSDK::Internal::Util::ServerSentEvent) }
