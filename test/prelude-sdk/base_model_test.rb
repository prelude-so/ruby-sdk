...
class PreludeSDK::Test::BaseModelTest < Minitest::Test
  ...
  def test_basic
    assert(E1.is_a?(PreludeSDK::Converter))
  ...
  def test_basic_dump
    ...
    assert_pattern do
      PreludeSDK::Converter.dump(A2, %w[a b c]) => %w[a b c]
    end
  end
  ...
  def test_primitive_try_strict_coerce
    ...
    cases.each do |test, expect|
      type, input = test
      assert_pattern do
        PreludeSDK::Converter.try_strict_coerce(type, input) => ^expect
      end
    end
  end
  ...
  def test_basic_enum_try_strict_coerce
    ...
    cases.each do |input, expect|
      assert_pattern do
        PreludeSDK::Converter.try_strict_coerce(E1, input) => ^expect
      end
    end
  end
  ...
  def test_basic_array_try_strict_coerce
    ...
    cases.each do |input, expect|
      assert_pattern do
        PreludeSDK::Converter.try_strict_coerce(A1, input) => ^expect
      end
    end
  end
  ...
  def test_nested_array_try_strict_coerce
    ...
    cases.each do |input, expect|
      assert_pattern do
        PreludeSDK::Converter.try_strict_coerce(A2, input) => ^expect
      end
    end
  end
  ...
  def test_basic_model_coerce
    ...
    cases.each do |input, expect|
      assert_pattern do
        PreludeSDK::Converter.coerce(M2, input) => ^expect
      end
    end
  end
  ...
  def test_basic_model_dump
    ...
    cases.each do |input, expect|
      assert_pattern do
        PreludeSDK::Converter.dump(M2, input) => ^expect
      end
    end
  end
  ...
  def test_basic_model_try_strict_coerce
    ...
    cases.each do |input, expect|
      assert_pattern do
        PreludeSDK::Converter.try_strict_coerce(M1, input) => ^expect
      end
    end
  end
  ...
  def test_nested_model_dump
    ...
    models.product(inputs).each do |model, input|
      assert_pattern do
        PreludeSDK::Converter.dump(model, input) => {a: now, renamed: "a", c: [1, 2, 3]}
      end
    end
  end
  ...
  class M4 < M2
    required :c, M1
    required :d, PreludeSDK::ArrayOf[M4]
  ...
  A3 = PreludeSDK::ArrayOf[A1]

  class M3 < M1
    optional :b, E1, api_name: :renamed_again
  end

  class U1 < PreludeSDK::Union
    discriminator :type
    variant :a, M1
    variant :b, M3
  end

  class U2 < PreludeSDK::Union
    variant A1
    variant A3
  end

  def test_basic_union
    assert(U1.is_a?(PreludeSDK::Converter))
  ...
  def test_basic_discriminated_union_coerce
    ...
    cases.each do |input, expect|
      assert_pattern do
        PreludeSDK::Converter.coerce(U1, input) => ^expect
      end
    end
  end
  ...
  def test_basic_discriminated_union_dump
    ...
    cases.each do |input, expect|
      assert_pattern do
        PreludeSDK::Converter.dump(U1, input) => ^expect
      end
    end
  end
  ...
  def test_basic_undifferentiated_union_try_strict_coerce
    ...
    cases.each do |input, expect|
      assert_pattern do
        PreludeSDK::Converter.try_strict_coerce(U2, input) => ^expect
      end
    end
  end

  class C1 < PreludeSDK::BaseModel
    required :a, const: :a
  ...
  class E2 < PreludeSDK::Enum
    A = :a
    B = :b
  end

  class U3 < PreludeSDK::Union
    discriminator :type
    variant :a, M1
    variant :b, M3
  end
  ...
  def test_basic_eql
    assert_equal(PreludeSDK::Unknown, PreludeSDK::Unknown)
    refute_equal(PreludeSDK::Unknown, PreludeSDK::BooleanModel)
    assert_equal(PreludeSDK::BooleanModel, PreludeSDK::BooleanModel)
