...
class PreludeSDK::Test::SorbetRuntimeSupportTest < Minitest::Test
  ...
  class M < PreludeSDK::Internal::Type::BaseModel
  ...
  def test_nil_aliases
    ...
    assert_raises(err) { PreludeSDK::Internal::Type::BaseModel::KnownField }
    assert_raises(err) { PreludeSDK::Internal::Util::ParsedUri }
    assert_raises(err) { PreludeSDK::Internal::Util::ServerSentEvent }
    assert_raises(err) { PreludeSDK::Internal::Transport::BaseClient::RequestComponents }
    assert_raises(err) { PreludeSDK::Internal::Transport::BaseClient::RequestInput }
    assert_raises(err) { PreludeSDK::Internal::Transport::PooledNetRequester::Request }
