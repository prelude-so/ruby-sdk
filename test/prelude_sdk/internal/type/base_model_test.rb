...
class PreludeSDK::Test::PrimitiveModelTest < Minitest::Test
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => PreludeSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      ...
      [PreludeSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [PreludeSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = PreludeSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        PreludeSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [PreludeSDK::Internal::Type::Boolean, true] => true,
      [PreludeSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        PreludeSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = PreludeSDK::Internal::Type::Converter.new_coerce_state
      PreludeSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        PreludeSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class PreludeSDK::Test::UnionTest < Minitest::Test
  class U0
    include PreludeSDK::Internal::Type::Union
...
class PreludeSDK::Test::BaseModelQoLTest < Minitest::Test
  ...
  def test_equality
    cases = {
      ...
      [PreludeSDK::Internal::Type::Boolean, PreludeSDK::Internal::Type::Boolean] => true,
      [PreludeSDK::Internal::Type::Unknown, PreludeSDK::Internal::Type::Boolean] => false,
...
class PreludeSDK::Test::MetaInfoTest < Minitest::Test
  A1 = PreludeSDK::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = PreludeSDK::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
