...
class PreludeSDKTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/v2/verification").to_return_json(status: 500, body: {})
  ...
  def test_client_given_request_default_retry_attempts
    ...
    prelude = PreludeSDK::Client.new(base_url: "http://localhost", api_token: "My API Token", max_retries: 3)
  ...
  def test_client_retry_after_seconds
    stub_request(:post, "http://localhost/v2/verification").to_return_json(
      status: 500,
      headers: {"retry-after" => "1.3"},
      body: {}
    )

    prelude = PreludeSDK::Client.new(base_url: "http://localhost", api_token: "My API Token", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_requested(:any, "http://localhost/redirected", times: PreludeSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: PreludeSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: PreludeSDK::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/v2/verification").to_return_json(status: 200, body: {})
