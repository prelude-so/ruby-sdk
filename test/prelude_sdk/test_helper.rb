...
class PreludeSDK::Test::SingletonClient < PreludeSDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: PreludeSDK::Test::SingletonClient::TEST_API_BASE_URL, api_token: "My API Token")
  end
end
...
class PreludeSDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @prelude = PreludeSDK::Test::SingletonClient.instance
  end
