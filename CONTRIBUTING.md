...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/prelude_sdk/helpers/` and `examples/` directory.
...
```ruby
gem "prelude-sdk", git: "https://www.github.com/prelude-so/ruby-sdk"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/prelude-so/ruby-sdk' '<path-to-repo>'
```

```ruby
gem "prelude-sdk", path: "<path-to-repo>"
```
